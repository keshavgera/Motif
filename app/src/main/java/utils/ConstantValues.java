...
public class ConstantValues {
	...
	public static final String SignUpClientDropDown = Motif + "dropDown";
	public static final String SignUp = Motif + "signup";
	public static final String DOWNLOADLIST = Motif + "files";
	public static final String YesIHave = Motif + "assignrequirements";
	public static final String IMAGEUPLOADProfile = Motif + "SignUp";
	public static final String Offers = Motif + "offers";
